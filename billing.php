...
<div class="container-fluid">
    <div class="row">&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <span style="margin-left: 5px;" class="active-step">Step2</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="mb-3">
                <label class="form-label"><b>Advance Payment to be made for Booking (Rs.)</b></label>
            ...
            <div class="card" id="pd-card">
                ...
                <div class="card-body">
                    <form action="pay.php" method="POST">
                        ...
                        <input type="hidden" name="paid" value="<?php echo fetchAmount($_SESSION['rooms-arr']); ?>" readonly>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" maxlength="12" minlength="12" class="form-control" name="aadhaar" required>
                                </div>
                            </div>
                        </div>               
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <button type="submit" name="pay_btn" id="pay_btn" class="btn btn-primary">Proceed to payment</button>
                        </div>
                    </form>
                </div>
            </div>  
